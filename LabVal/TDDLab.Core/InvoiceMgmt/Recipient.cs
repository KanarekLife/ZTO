    ...
    public class Recipient : ValidatedDomainObject
    {
        ...
        public sealed class ValidationRules
        {
            ...
            public static IBusinessRule<Recipient> Address
            {
                get
                {
                    return new BusinessRule<Recipient>(MethodBase.GetCurrentMethod().Name, "Address should be valid", recipient => recipient != null && recipient.Address != null && recipient.Address.IsValid);
                }
            }
        }
